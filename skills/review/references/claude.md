...
Capture the returned session handle. When that reviewer first reports findings, start a different fresh subagent as its finding auditor and capture that handle. Resume those same sessions for every later exchange and re-review in the round.
